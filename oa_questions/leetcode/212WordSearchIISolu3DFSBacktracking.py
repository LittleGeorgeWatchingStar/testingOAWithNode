# 212WordSearchIISolu3DFSBacktracking
# Depth first seach is the most intuitive thing 
# for word matching in the grid. I have used trie to 
# eliminate duplicate search by cutting visited leaves 
# and for early stopping if prefix is not present in any of 
# the given word set.
'''
